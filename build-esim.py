...
# Utility to build eSIM profile structure on Jcard-based eSIM
#
...
def write_EF(ef, parent):
    ...
    print(ef)
    try:
        sr.send_apdu(ins = 'a4',p1 = '08', p2 = '00', data = parent)
        # sr.send_apdu(ins = 'a4',p1 = '00', p2 = '00', data = parent)
        sr.send_apdu(ins='e0', p1='00', p2='00', data=ef.fci)
        sr.send_apdu(ins='a4', p1='08', p2='00', data=parent+ef.name)
        if ef.tp == "transparent":
        ...
        print(ef, "Create Failed")
        # sr.send_apdu(ins='a4', p1='00', p2='04', data='3F00')
        print(sr.send_apdu_text('00b4000000'))
...
if __name__ == '__main__':
    ...
    mf, adf, gsm, telecom = load_profile("./profile-read/")

    for profile in ['00a9010000', '00a9020000', '00a9030000']:
        # print(sr.send_apdu_text(profile))
        print(sr.send_apdu_text('00a8000006'))
    ...
    # print(sr.send_apdu_text('00a9010000'))
    # print(sr.send_apdu_text('00a6030000'))
    # print(sr.send_apdu_text('00a6020000'))
